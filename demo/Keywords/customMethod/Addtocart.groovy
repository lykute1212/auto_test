...
public class Addtocart {
	...
	public addItem(int n) {
		...
		for(int i = 1; i <= n; i++) {
			WebUI.click(findTestObject('Object Repository/Object_Store/Add to cart/div_home__product-item-img')) //bấm item để vào trang chi tiết product
			...
			WebUI.click(findTestObject('Object Repository/Object_Store/Add to cart/btn_home'))// quay lại trang chủ
