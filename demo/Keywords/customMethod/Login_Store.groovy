...
public class Login_Store {
	@Keyword
	def loginStore(String email, String pass) {
		...
		WebUI.setEncryptedText(findTestObject('Object Repository/Object_Store/Login_Store/input_Pass'), pass)
